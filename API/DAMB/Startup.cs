...
namespace DAMB
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IFWRepository, FWRepository>();
            services.AddTransient<FWServices>();
            services.AddTransient<ITLRepository, TLRepository>();
            services.AddTransient<TLServices>();
            services.AddTransient<IMutichoiceRepository, MutichoiceRepository>();
            services.AddTransient<MutichoiceServices>();
